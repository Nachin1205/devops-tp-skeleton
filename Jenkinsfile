pipeline {
    ...
    environment {
        ...
        DOCKERHUB_CREDENTIALS = 'dckr_pat_TudYL9TeQDKcEAzZjGO_2HWUvoY'  // credencial en Jenkins
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/Nachin1205/devops-tp-skeleton.git'
            }
        }
